...
class DataListHalfproduct extends Component{
     constructor(props){
         super(props);
         this.state={ 
             data:[],
          ...
          />
              ...
              <Autocomplete
                  ...
                  onChange={(event,newValue)=>{
                    ...
                    if(newValue){
                          this.setState({
                            productpartnumber:newValue.productpartnumber
                          })
                      }
                  }}}
                  onInputChange={(e)=>{
                    if(this.state.showadd ==true || this.state.showEdit ==true){
                        this.setState({
                          productpartnumber:e.target.value
                   })
                    }
                  }}
...
export default DataListHalfproduct